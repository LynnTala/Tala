...
# FRAMES
        ...
        MainFrame = Frame(self.root, bd=7, width=1300, height=750, relief=RIDGE, bg="teal")
        MainFrame.grid()
        
        BotFrame = Frame(MainFrame,  width=1330, height=130, relief=RIDGE,bg="teal")
        BotFrame.grid(row=2, column=0)
        
        TitleFrame = Frame(MainFrame, bg="teal", width=1340, height=100, relief=RIDGE)
        TitleFrame.grid(row=0, column=0)
        
        MidFrame = Frame(MainFrame, bd=5,bg="cyan", width=1340, height=450, relief=RIDGE)
        ...
        RightFrame = Frame(MidFrame, bd=5, width=1350, height=400, padx=2, bg="white", relief=RIDGE)
        RightFrame.pack(side=RIGHT)

        LeftFrame = Frame(MidFrame, bd=5, width=600, height=400, padx=2, bg="white", relief=RIDGE)
        LeftFrame.pack(side=LEFT)
        
        RightFrame1 = Frame(RightFrame, bd=5,bg="purple", width=600, height=300, padx=2, pady=4, relief=RIDGE)
...
# Title
        ...
        self.lblTitle = Label(TitleFrame, font=('Bahnschrift',40,'bold'), text="STUDENT INFORMATION SYSTEM",bg="teal",fg="white",bd=7)
        self.lblTitle.grid(row=0, column=0, padx=135)
        

# Variables in GUI        
        
        self.lblStudentID = Label(RightFrame1, font=('Cambria',12,'bold'), text="STUDENT ID:",bg="lavender", bd=5 , anchor=W)
        ...
        self.lblLastName = Label(RightFrame1, font=('Cambria',12,'bold'), text="LAST NAME:",bg="lavender",bd=7, anchor=W)
        ...
        self.lblFirstName = Label(RightFrame1, font=('Cambria',12,'bold'), text="FIRST NAME:",bg="lavender", bd=7, anchor=W)
        ...
        self.lblMiddleInitial = Label(RightFrame1, font=('Cambria',12,'bold'), text="MIDDLE INITIAL:", bg="lavender",bd=7, anchor=W)
        ...
        self.lblCourse = Label(RightFrame1, font=('Cambria',12,'bold'), text="COURSE:",bg="lavender", bd=7, anchor=W)
        ...
        self.lblGender = Label(RightFrame1, font=('Cambria',12,'bold'), text="GENDER:", bg="lavender",bd=7, anchor=W)
        self.lblGender.grid(row=5, column=0, sticky=W, padx=5)
        
        self.cboGender = ttk.Combobox(RightFrame1, font=('Cambria',12,'bold'), state='readonly', width=39, textvariable = Student_Gender)
        self.cboGender['values'] = ('Female', 'Male')
        self.cboGender.grid(row=5, column=1)
        
        self.lblYearLevel = Label(RightFrame1, font=('Cambria',12,'bold'), text="YEAR LEVEL:", bg="lavender",bd=7, anchor=W)
        self.lblYearLevel.grid(row=6, column=0, sticky=W, padx=5)
        
        self.cboYearLevel = ttk.Combobox(RightFrame1, font=('Cambria',12,'bold'), state='readonly', width=39, textvariable = Student_YearLevel)
        self.cboYearLevel['values'] = ('1st Year', '2nd Year', '3rd Year', '4th Year')
        self.cboYearLevel.grid(row=6, column=1)
        
        self.searchbar = Entry(self.root, font=('Cambria',12,'bold'), textvariable = searchbar, width = 29 )
...
# GUI Buttons
        ...
        self.btnAddNew=Button(self.root, pady=1,bd=4,font=('Arial',16,'bold'), padx=12, width=8,fg="purple", text='ADD', command=addStudent)
        self.btnAddNew.place(x=80,y=480)
        
        self.btnClear=Button(self.root, pady=1,bd=4,font=('Arial',16,'bold'), padx=2, width=8,fg="purple", text='CLEAR', command=Clear)
        self.btnClear.place(x=250,y=480)
        
        self.btnUpdate=Button(self.root, pady=1,bd=4,font=('Arial',16,'bold'), padx=2, width=8,fg="purple", text='UPDATE', command=updateData)
        self.btnUpdate.place(x=400,y=480)

        self.btnEdit=Button(self.root, pady=1,bd=4,font=('Arial',16,'bold'), padx=2, width=8,fg="purple", text='EDIT', command = editData)
        self.btnEdit.place(x=550,y=480)

        self.btnDisplay=Button(self.root, pady=1,bd=4, font=('Arial', 16, 'bold'),padx=2,width=8, fg="purple",text="DISPLAY" , command=displayData)
        self.btnDisplay.place(x=700,y=480)

        self.btnDelete=Button(self.root, pady=1,bd=4,font=('Arial',16,'bold'), padx=2, width=8,fg="white",bg="orange", text='DELETE',command = deleteData)
        self.btnDelete.place(x=850,y=480)

        self.btnExit=Button(self.root, pady=1,bd=4,font=('Arial',16,'bold'), padx=2, width=8,fg="white",bg="red", text='EXIT',command = iExit)
        self.btnExit.place(x=1150,y=480)

        self.btnSearch=Button(self.root, pady=1,bd=4,font=('Arial',9,'bold'), padx=2, width=13, text='Search by ID:',fg="white",bg="blue", command = searchData)
